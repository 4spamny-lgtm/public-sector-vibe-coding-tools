...
echo ============================================
echo Hancom HWP/HWPX to PDF Batch Converter
echo ============================================
echo.
...
"%CSC32%" /nologo /target:winexe /platform:x86 /optimize+ /reference:System.dll /reference:System.Core.dll /reference:System.Drawing.dll /reference:System.Windows.Forms.dll /reference:Microsoft.CSharp.dll /out:"dist\HancomPdfBatch.exe" "src\Program.cs"
if errorlevel 1 goto BUILD_FAIL
echo.
echo SUCCESS: dist\HancomPdfBatch.exe
echo.
goto OPEN_DIST
